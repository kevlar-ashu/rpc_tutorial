...
// Item struct which have two data...
type Item struct {
	Title string
	Body  string
}

// API of type int will make take return....
type API int

var database []Item

// GetDB method will take two argument...
func (a *API) GetDB(empty string, reply *[]Item) error {
	*reply = database
	return nil
}

// GetByName method will take two argument...
...
// AddItem method will take two argument...
...
// EditItem method will take two argument...
...
// DeleteItem method will take two argument...
